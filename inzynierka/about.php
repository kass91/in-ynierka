...
<!----blog----->
	<div id='blog'>
        <div class="post">
            <div class="post-image"><img src='img/LE.png' /></div>
            <div class="post-tit"><br/></div>
            <div class="post-tre"><b>Learn English</b> to portal tworzony z pasją i zamiłowaniem do nauki języka angielskiego przez grono wyspecjalizowanych lektorów językowych, tłumaczy oraz nauczycieli.
            Dzięki zdobytej wiedzy, nasi specjaliści przygotowali szereg zagadnień, przykładów oraz ćwiczeń, które ułatwią Państwu naukę tak bardzo obecnie popularnego języka angielskiego.</div>
            <div class="post-podpis"><b>Załoga Learn English</b></div>  
        </div>
    </div>
</body>
</html>